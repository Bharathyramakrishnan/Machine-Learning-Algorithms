...
highsales = ifelse(CompanyData$Sales<10, "No", "Yes") 
...
confusionMatrix(pred2, test$highsales) # 85.22 % accuracy on test data
...
# if the price is 100 or greater, than they are not buying those products.
